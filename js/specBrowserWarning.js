...
if (version > 0 && version <= 11) {
    var   graph = document.getElementById('graph')
        ...
        , foafDetails = document.getElementById('foafDetails')
    ...
    foafDetails.style.display = "none";
    browserCheck.style.display = "block";

    browserCheck.innerHTML = "The WebVOWL demo does not work in Internet Explorer. Please use another browser, such as <a href=\"http://www.mozilla.org/firefox/\">Mozilla Firefox</a> or <a href=\"https://www.google.com/chrome/\">Google Chrome</a>, to run the WebVOWL demo.";
}